...
def plot_arrow(x, y, yaw, length=0.02, width=0.02, fc="r", ec="k"):  # pragma: no cover
    """Plot arrow."""
...
def main():
    ...
    start_x = 0.81755897371  # [m]
    start_y = -0.022543861  # [m]
    start_yaw = 0.018179272 #np.radians(177.0)  # [rad]

    end_x = 1.29511319651 # [m]
    end_y = 0.0926054845  # [m]
    end_yaw = 0.045463800 # np.radians(180.0)  # [rad]
    offset = 3.0
