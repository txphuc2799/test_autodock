...
def main():
    ...
    x_start = -0.3200865882986628*10
    y_start = 0.0023621564704253122*10
    theta_start = 3.1256497123771263
    x_goal = -0.5660251964917699*10
    y_goal = -0.07445602879582655*10
    theta_goal = 3.099726705152522
